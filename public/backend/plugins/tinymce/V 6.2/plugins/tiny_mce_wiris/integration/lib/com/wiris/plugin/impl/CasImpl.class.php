...
class com_wiris_plugin_impl_CasImpl implements com_wiris_plugin_api_Cas{
	...
	public function printCASContainer($config, $availableLanguages, $lang) {
		...
		$output->add("/*<!--*/ html, body, #optionForm { height: 100%; } body { overflow: hidden; margin: 0; } #controls { width: 100%; } /*-->*/</style><?php include "../css/header.php" ?></head>");
	...
	public function printCAS($codebase, $archive, $className) {
		$output = new StringBuf();
		$output->add("<html><head><style type=\"text/css\">/*<!--*/ html, body { height: 100%; } body { overflow: hidden; margin: 0; } applet { height: 100%; width: 100%; } /*-->*/</style><?php include "../css/header.php" ?></head>");
