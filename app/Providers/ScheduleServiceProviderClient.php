...
class ScheduleServiceProviderClient extends ServiceProvider
{
    ...
    public function boot(): void
    {
        $this->app->booted(function () {
            ...
            */
            // CetakAbsensiCommand
            $schedule->command('absensi:cetak-absensi-guru')->monthlyOn(1, '09:00')->runInBackground();
            ...
            //     $schedule->command('absensi:cetak-absensi-guru')->at('13:20')->runInBackground();
            //     $schedule->command('absensi:rekap-bulanan-siswa')->at('13:20')->runInBackground();
            // }
            // Shalat Berjamaah
            /*
                |--------------------------------------------------------------------------
