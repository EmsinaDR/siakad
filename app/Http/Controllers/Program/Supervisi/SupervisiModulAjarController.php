...
use App\Models\Program\Supervisi\SupervisiModulAjar;
use App\Models\Program\Supervisi\SupervisiInstrument;

class SupervisiModulAjarController extends Controller
{
    /**
...
php artisan make:view role.program.supervisi.supervisi-modul-ajar
php artisan make:view role.program.supervisi.supervisi-modul-ajar-single
php artisan make:model Program/Supervisi/SupervisiModulAjar
php artisan make:controller Program/Supervisi/SupervisiModulAjarController --resource



php artisan make:seeder Program/Supervisi/SupervisiModulAjarSeeder
php artisan make:migration Migration_SupervisiModulAjar
...
*/
    ...
    role.program.supervisi.supervisi-modul-ajar
    role.program.supervisi.blade_show
    Index = Data Supervisi Modul Ajar
    Breadcume Index = 'Data Supervisi / Data Supervisi Modul Ajar';
    Single = titel_data_single
    php artisan make:view role.program.supervisi.supervisi-modul-ajar
    php artisan make:view role.program.supervisi.supervisi-modul-ajar-single
    php artisan make:seed SupervisiModulAjarSeeder
    ...
    */
    public function index()
    {
        //
        //Title to Controller
        $title = 'Data Supervisi Modul Ajar';
        $arr_ths = [
            'Nama Guru',
            'Mapel',
            'Kelas',
        ];
        $breadcrumb = 'Data Supervisi / Data Supervisi Modul Ajar';
        $titleviewModal = 'Lihat Data Supervisi Modul Ajar';
        $titleeditModal = 'Edit Data Supervisi Modul Ajar';
        $titlecreateModal = 'Create Data Supervisi Modul Ajar';
        $etapels = Etapel::where('aktiv', 'Y')->first();
        $datas = SupervisiModulAjar::where('tapel_id', $etapels->id)->get();
        ...
        return view('role.program.supervisi.supervisi-modul-ajar', compact(
            'datas',
            'title',
            'arr_ths',
            'breadcrumb',
    ...
    public function show($id, Request $request)
    {
        ...
        $datas = SupervisiATP::where('tapel_id', $request->tapel_id)
            ...
            ->get();
        // dd($datas);
        // $Instrumens = SupervisiInstrument::where('kategori', 'Modul Ajar')->get()->groupBy('sub_kategori');

        // Gabungkan data dari SupervisiInstrument dengan join dan pastikan tidak ada duplikasi

        $Instrumens = \App\Models\Program\Supervisi\SupervisiInstrument::where('kategori', 'Modul Ajar')
        ...
        // $Instrumens = SupervisiInstrument::where('kategori', 'Modul Ajar')
        //     ->join('supervisi_pembelajaran', 'supervisi_instrument.id', '=', 'supervisi_pembelajaran.indikator_id')
        //     ->select('supervisi_instrument.*', 'supervisi_pembelajaran.*')
        ...
        // Kirim data ke view
        return view('role.program.supervisi.supervisi-modul-ajar-single', compact(
            'datas',
            'title',
            'arr_ths',
            'breadcrumb',
        ...
        //compact => 'title', 'arr_ths', 'breadcrumb', 'titleviewModal', 'titleeditModal', 'titlecreateModal'
        return view('role.program.supervisi.supervisi-modul-ajar-single', compact('datas', 'title', 'arr_ths', 'breadcrumb', 'titleviewModal', 'titleeditModal', 'titlecreateModal'));
        //php artisan make:view role.program.supervisi.supervisi-modul-ajar-guru-single
    }
    ...
    public function store(Request $request)
    {
        ...
        $Indikators = SupervisiInstrument::where('kategori', 'Modul Ajar')->get();
        ...
        // dd($lastSupervisi);
        return redirect()->route('supervisi-modul-ajar-guru.show', [
            'supervisi_modul_ajar_guru' => $lastSupervisi->id, // Pastikan ini tidak null
            'detailguru_id' => $request->input('detailguru_id'),
            'tapel_id' => $request->tapel_id,
            'semester' => $request->semester,
            'mapel_id' => $request->mapel_id,
    ...
    public function destroy($id)
    {
        ...
        // dd($id);
        // dd($request->all());
        $data = SupervisiModulAjar::findOrFail($id);
        $data->delete();
