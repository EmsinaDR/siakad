...
use App\Models\Program\Supervisi\SupervisiPerangkatGuru;
use Database\Seeders\Program\Supervisi\SupervisiPerangkatGuruSeeder;

class SupervisiPerangkatGuruController extends Controller
{
    /**
...
php artisan make:view role.program.supervisi.supervisi-perangkat-guru
php artisan make:view role.program.supervisi.supervisi-perangkat-guru-single
php artisan make:model Program/Supervisi/SupervisiPerangkatGuru
php artisan make:controller Program/Supervisi/SupervisiPerangkatGuruController --resource



php artisan make:seeder Program/Supervisi/SupervisiPerangkatGuruSeeder
php artisan make:migration Migration_SupervisiPerangkatGuru
...
*/
    /*
    SupervisiPerangkatGuru
    $datasupguru
    role.program.supervisi
    role.program.supervisi.supervisi-perangkat-guru
    role.program.supervisi.blade_show
    Index = Data Supervisi Perangkat
    Breadcume Index = 'Supervisi Guru / Data Supervisi Perangkat';
    Single = Data Supervisi Perangkat
    php artisan make:view role.program.supervisi.supervisi-perangkat-guru
    php artisan make:view role.program.supervisi.supervisi-perangkat-guru-single
    php artisan make:seed SupervisiPerangkatGuruSeeder
    ...
    */
    public function index()
    {
        ...
        $titleviewModal = 'Lihat Data Supervisi Perangkat';
        $titleeditModal = 'Edit Data Supervisi Perangkat';
        $titlecreateModal = 'Create Data Supervisi Perangkat';
        $etapels = Etapel::where('aktiv', 'Y')->first();
        $datas = SupervisiPerangkatGuru::where('tapel_id', $etapels->id)->get();
        ...
        return view('role.program.supervisi.supervisi-perangkat-guru', compact(
            'datas',
            'title',
            'arr_ths',
            'breadcrumb',
    ...
    public function show($id, Request $request)
    {
        ...
        $datas = SupervisiPerangkatGuru::where('tapel_id', $request->tapel_id)
            ...
            ->get();
        // dd($datas);
        // $Instrumens = SupervisiInstrument::where('kategori', 'Administrasi Pembelajaran')->get()->groupBy('sub_kategori');

        // Gabungkan data dari SupervisiInstrument dengan join dan pastikan tidak ada duplikasi

        $Instrumens = \App\Models\Program\Supervisi\SupervisiInstrument::where('kategori', 'Administrasi Pembelajaran')
        ...
        // $Instrumens = SupervisiInstrument::where('kategori', 'Administrasi Pembelajaran')
        //     ->join('supervisi_pembelajaran', 'supervisi_instrument.id', '=', 'supervisi_pembelajaran.indikator_id')
        //     ->select('supervisi_instrument.*', 'supervisi_pembelajaran.*')
        ...
        // Kirim data ke view
        return view('role.program.supervisi.supervisi-perangkat-guru-single', compact(
            'datas',
            'title',
            'arr_ths',
            'breadcrumb',
        ...
        //compact => 'title', 'arr_ths', 'breadcrumb', 'titleviewModal', 'titleeditModal', 'titlecreateModal'
        return view('role.program.supervisi.supervisi-perangkat-guru-single', compact('datas', 'title', 'arr_ths', 'breadcrumb', 'titleviewModal', 'titleeditModal', 'titlecreateModal'));
        //php artisan make:view role.program.supervisi.supervisi-perangkat-guru-single
    }
    ...
    public function store(Request $request)
    {
        ...
        $Indikators = SupervisiInstrument::where('kategori', 'Administrasi Pembelajaran')->get();
        $firstId = null; // Inisialisasi variabel ID pertama
        $lastSupervisi = null;

        foreach ($Indikators as $indikator) {
            $CekData = SupervisiPerangkatGuru::where('indikator_id', $indikator->id)
                ->where('kelas_id', $request->kelas_id)
                ->where('mapel_id', $request->mapel_id)
            ...
            $lastSupervisi = SupervisiPerangkatGuru::create([
                'tapel_id' => $request->tapel_id,
                'detailguru_id' => $request->input('detailguru_id'),
        ...
        if (!$lastSupervisi) {
            $lastSupervisi = SupervisiPerangkatGuru::latest('id')->first();
        }
        ...
        return redirect()->route('supervisi-perangkat-guru.show', [
            'supervisi_perangkat_guru' => $lastSupervisi->id, // Pastikan ini tidak null
            'detailguru_id' => $request->input('detailguru_id'),
            'tapel_id' => $request->tapel_id,
            'semester' => $request->semester,
            'mapel_id' => $request->mapel_id,
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $indicator = SupervisiPerangkatGuru::find($id);
    ...
    public function destroy($id)
    {
        ...
        // dd($id);
        // dd($request->all());
        $data = SupervisiPerangkatGuru::findOrFail($id);
        $data->delete();
