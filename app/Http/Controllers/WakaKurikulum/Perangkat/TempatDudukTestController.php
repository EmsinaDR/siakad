...
class TempatDudukTestController extends Controller
{
    /**
...
php artisan make:model WakaKurikulum/Perangkat/TempatDudukTest
php artisan make:controller WakaKurikulum/Perangkat/TempatDudukTestController --resource



php artisan make:seeder WakaKurikulum/Perangkat/TempatDudukTestSeeder
php artisan make:migration Migration_TempatDudukTest
    ...
    Index = Pasangan Duduk
    Breadcume Index = 'Waka Kurikulum/ Perangkat Test  / Pasangan Duduk';
    Single = titel_data_single
    php artisan make:view role.waka.kurikulum.Perangkat.tempat-duduk
    php artisan make:view role.waka.kurikulum.Perangkat.tempat-duduk-single
    php artisan make:seed TempatDudukTestSeeder
    ...
    */
    public function index()
    {
        ...
        $titleviewModal = 'Lihat Data Pasangan Duduk';
        $titleeditModal = 'Edit Data Pasangan Duduk';
        $titlecreateModal = 'Create Data Pasangan Duduk';
        $datas = TempatDudukTest::get();
    ...
    public function store(Request $request)
    {
        ...
        TempatDudukTest::create($validator->validated());
        Session::flash('success', 'Data Berhasil Disimpan');
        return Redirect::back();
    }
    public function update($id, Request $request, TempatDudukTest $tempatduduktest)
    {
        //
        ...
        $varmodel = TempatDudukTest::find($id); // Pastikan $id didefinisikan atau diterima dari request
        if ($varmodel) {
    ...
    public function destroy($id)
    {
        ...
        // dd($id);
        // dd($request->all());
        $data = TempatDudukTest::findOrFail($id);
        $data->delete();
