...
class IdentitasController extends Controller
{
    ...
    public function index()
    {
        ...
        $identitas_sekolah = Cache::tags(['identitas_sekolah'])->remember('identitas_sekolah', now()->addHours(2), function () {
            return Identitas::first();
        });
        // return $identitas;
        // dd($identitas);
        $title = 'Identitas Sekolah';
        return view('admin.identitas.index', compact('identitas_sekolah', 'title', 'breadcrumb'));
    }
