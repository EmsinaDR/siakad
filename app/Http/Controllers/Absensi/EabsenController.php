...
class EabsenController extends Controller
{
    ...
    public function storeSiswaAjax(Request $request)
    {
        ...
        // Pastikan model Eabsen punya $fillable untuk 'telat', 'pulang_cepat', 'pulang_telat'
        // dan di-cast sebagai integer, bukan boolean
        // ==========================
        $etapels = Etapel::where('aktiv', 'Y')->first();
        ...
        // $result = \App\Models\Whatsapp\WhatsApp::sendMessage(config('whatsappSession.IdWaUtama'), '6285329860005', $pulangCepat . ' - ' . $pulangTelat);
