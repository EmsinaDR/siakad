    ...
    function Auto_Reply_OperatorHelper($Kode, $NoRequest, $message)
    {
        ...
        switch (ucfirst($Kode)) {
            ...
            case 'Export Data':
                ...
                $selectData = ['id', 'nama_siswa', 'kelas_id', 'nis', 'nisn', 'tanggal_lahir', 'alamat_siswa'];
            ...
            case 'Export Data Emis':
                ...
                if (isset($pesan[3])) {
                    ...
                    $data = "id:kelas_id:nis:nik:nisn:nama_siswa:jenis_kelamin:tempat_lahir:tanggal_lahir:namasek_asal:alamat_siswa:kecamatan:desa:kode_pos:nokk:ayah_nama:ayah_pekerjaan";
                    // ayah_nama:ayah_nik:ayah_pekerjaan
            ...
            case 'Buku Induk':
                //Buku Induk / Operator / arraynis / cetak / wa
                // Buku Induk / Operator / 230019:230020
                $Identitas = getIdentitas();
                $pesan = explode('/', $message); // Memecah Array yang yang telah diterima, lanjut fungsi loop fetch

                $nis = explode(':', $pesan[2]);
                $Siswas = Detailsiswa::whereIn('nis',  $nis)->get();

                foreach ($Siswas as $Siswa):
                    $file = TemplateWordHelperx([
                        'template' => public_path('template/template_buku_induk.docx'),
                        'output'   => public_path('template/Buku Induk ' . $Siswa->nis . '.docx'),
                        ...
                        'values' => [
                            ...
                            'yatim' => $Siswa->status_yatim_piatu ?? '-',
                            'bahasa' => $Siswa->bahasa ?? '-',
                            'jalan' => $Siswa->jalan ?? '-',
                            'rt' => $Siswa->rt ?? '-',
                            'rw' => $Siswa->rw ?? '-',
                            ...
                            'alasan_pindah' => $Siswa->alasan_pindah ?? '-',
                            'kelas_penerimaan' => $Siswa->kelas_penerimaan ?? '-',
                            // Ayah
                            'ayah_nama' => $Siswa->ayah_nama ?? '-',
                            'ayah_agama' => $Siswa->ayah_agama ?? '-',
                            'ayah_kewarganegaraan' => $Siswa->ayah_kewarganegaraan ?? '-',
                            'ayah_pendidikan' => $Siswa->ayah_pendidikan ?? '-',
                            'ayah_pekerjaan' => $Siswa->ayah_pekerjaan ?? '-',
                            'ayah_penghasilan' => $Siswa->ayah_penghasilan ?? '-',
                            'ayah_jalan' => $Siswa->ayah_jalan ?? '-',
                            'ayah_rt' => $Siswa->ayah_rt ?? '-',
                            'ayah_rw' => $Siswa->ayah_rw ?? '-',
                            'ayah_desa' => $Siswa->ayah_desa ?? '-',
                            'ayah_kecamatan' => $Siswa->ayah_kecamatan ?? '-',
                            'ayah_kabupaten' => $Siswa->ayah_kabupaten ?? '-',
                            'ayah_provinsi' => $Siswa->ayah_provinsi ?? '-',
                            'ayah_kode_pos' => $Siswa->ayah_kode_pos ?? '-',
                            'ayah_nohp' => $Siswa->ayah_nohp ?? '-',
                            'ayah_keadaan' => $Siswa->ayah_keadaan ?? '-',
                            // Ibu
                            'ibu_nama' => $Siswa->ibu_nama ?? '-',
                            'ibu_agama' => $Siswa->ibu_agama ?? '-',
                            'ibu_kewarganegaraan' => $Siswa->ibu_kewarganegaraan ?? '-',
                            'ibu_pendidikan' => $Siswa->ibu_pendidikan ?? '-',
                            'ibu_pekerjaan' => $Siswa->ibu_pekerjaan ?? '-',
                            'ibu_penghasilan' => $Siswa->ibu_penghasilan ?? '-',
                            'ibu_jalan' => $Siswa->ibu_jalan ?? '-',
                            'ibu_rt' => $Siswa->ibu_rt ?? '-',
                            'ibu_rw' => $Siswa->ibu_rw ?? '-',
                            'ibu_desa' => $Siswa->ibu_desa ?? '-',
                            'ibu_kecamatan' => $Siswa->ibu_kecamatan ?? '-',
                            'ibu_kabupaten' => $Siswa->ibu_kabupaten ?? '-',
                            'ibu_provinsi' => $Siswa->ibu_provinsi ?? '-',
                            'ibu_kode_pos' => $Siswa->ibu_kode_pos ?? '-',
                            'ibu_nohp' => $Siswa->ibu_nohp ?? '-',
                            'ibu_keadaan' => $Siswa->ibu_keadaan ?? '-',
                            // Wali
                            'wali_nama' => $Siswa->wali_nama ?? '-',
                            'wali_agama' => $Siswa->wali_agama ?? '-',
                            'wali_kewarganegaraan' => $Siswa->wali_kewarganegaraan ?? '-',
                            'wali_pendidikan' => $Siswa->wali_pendidikan ?? '-',
                            'wali_pekerjaan' => $Siswa->wali_pekerjaan ?? '-',
                            'wali_penghasilan' => $Siswa->wali_penghasilan ?? '-',
                            'wali_jalan' => $Siswa->wali_jalan ?? '-',
                            'wali_rt' => $Siswa->wali_rt ?? '-',
                            'wali_rw' => $Siswa->wali_rw ?? '-',
                            'wali_desa' => $Siswa->wali_desa ?? '-',
                            'wali_kecamatan' => $Siswa->wali_kecamatan ?? '-',
                            'wali_kabupaten' => $Siswa->wali_kabupaten ?? '-',
                            'wali_provinsi' => $Siswa->wali_provinsi ?? '-',
                            'wali_kode_pos' => $Siswa->wali_kode_pos ?? '-',
                            'wali_nohp' => $Siswa->wali_nohp ?? '-',
                            'wali_keadaan' => $Siswa->wali_keadaan ?? '-',
                            // Kelulusan
                            'tahun_lulus' => $Siswa->tahun_lulus ?? '-',
                            'nomor_ijazah' => $Siswa->nomor_ijazah ?? '-',
                            'sekolah_lanjutan' => $Siswa->sekolah_lanjutan ?? '-',
                            'tanggal_bekerja' => $Siswa->tanggal_bekerja ?? '-',
                            'tempat_kerja' => $Siswa->tempat_kerja ?? '-',
                    ...
                    $filename = 'Buku Induk ' . $Siswa->nis . '.docx';
