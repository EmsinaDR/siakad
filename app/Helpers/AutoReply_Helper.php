        ...
        switch ($message) {
            ...
            case 'Help Siswa':
                $pesanKiriman = "" .
                    ...
                    "- Data BK : Data Point/BK/NIS(_Pemium Only_)\n" .
                    "- Data Kredit Point : Data Kredit Point/BK/NIS(_Pemium Only_)\n" .
                    "- Bimbingan : Bimbingan/BK/Kode Guru/NIS/Masalah(_Pemium Only_)\n" .
                    "- Jadwal Ekstra : Jadwal Ekstra/Siswa/NIS(_Pemium Only_)\n" .
                    "- Pembayaran : Pembayaran/Siswa/NIS (_Pemium Only_)\n" .
                    "- Tabungan : Tabungan/Siswa/25001(_Pemium Only_)\n" .
                    "\n" . str_repeat("─", 25) . "\n" .
            ...
            case 'Help Pencarian':
                $pesanKiriman =  "" .
                    ...
                    "Siswa/Cari/sekolah/nama sd/tingkat \n\n" .
