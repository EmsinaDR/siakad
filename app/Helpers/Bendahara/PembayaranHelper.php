...
if (!function_exists('PesanPembayaran')) {
    function PesanPembayaran($id)
    {
        ...
        if ($Identitas->paket !== 'Peremium') {
            if ($Siswa->tingkat_id === 7) {
                $rincian_pokok =
                    "Kelas VII :\n" .
                    "- Daftar Ulang Laki2 = Rp. 460.000,-  \n" .
                    "- Daftar Ulang perempuan = Rp. 500.000,-  \n" .
                    "- LKS 2 semester = Rp. 380.000,-  \n" .
                    "- Komite = Rp. 400.000,-  \n" .
                    "\n\n";
            } elseif ($Siswa->tingkat_id === 8) {
                $rincian_pokok =
                    "Kelas VIII :\n" .
                    ...
                    "- Study tour = -\n" .
                    "\n\n";
            } elseif ($Siswa->tingkat_id === 9) {
                $rincian_pokok =
                    "Kelas IX :\n" .
                    "- Daftar Ulang = Rp. 100.000,-  \n" .
                    "- LKS 2 semester = Rp. 380.000,-  \n" .
                    "- Komite = Rp. 400.000,-  \n" .
                    "- Ujian & akhirussanah = Rp. 1.200.000,-  \n" .
                    "\n\n";
            } else {
            }
            ...
            $isiPesan =
                ...
                "Yth. Bapak / Ibu Wali Murid dari Ananda *{$Siswa->nama_siswa}*, dimohon dengan hormat untuk segera melakukan kewajiban pembayaran pada *bulan {$bulan}*, demi kelancaran kegiatan - kegiatan putra / putri disekolah paling lambat tanggal 10.\n\n" .
