...
require_once __DIR__ . '/AutoReply_CetakHelper.php';
require_once __DIR__ . '/System/CommandControlHelper.php';

require_once __DIR__ . '/Test/PerangkatTestHelper.php';
require_once __DIR__ . '/System/WordToPdfHelper.php';
require_once __DIR__ . '/System/TabelDatabaseHelper.php';

require_once __DIR__ . '/System/TemplateWordHelper.php';
require_once __DIR__ . '/System/PdfHelper.php';