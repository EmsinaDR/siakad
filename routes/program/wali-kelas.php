...
Route::prefix('/wali-kelas/{kelas_id}')->middleware(['auth', 'CekDataSekolah', 'token.check', 'verified'])->group(
    function () {
        ...
        // php artisan make:custom-controller WaliKelas/DokumenSiswaController kk:ayah_ktp:ibu_ktp:ijazah:ijazah_sd:raport  dokumen-siswa
        Route::resource('dokumen-siswa', \App\Http\Controllers\WaliKelas\DokumenSiswaController::class)->middleware(['auth', 'verified']); //Belum
