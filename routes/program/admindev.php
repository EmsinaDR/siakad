...
Route::middleware(['web', 'auth', 'CekDataSekolah', 'verified', 'is_admindev'])->prefix('admindev')->group(function () {
    ...
    // php artisan make:custom-controller AdminDev/DataSekolahSMPController "ceklist/tanggal_kunjungan/nsm/npsn/akreditasi/nama_sekolah/alamat/kecamatan/kelurahan/status/siswa_l/siswa_p/nama_kepala/nohp_kepala/nama_operator"  data-referensi-sekolah-tingkat-smp --force
    Route::resource('data-referensi-sekolah-tingkat-smp', \App\Http\Controllers\AdminDev\DataSekolahSMPController::class)
        ->parameters(['data-referensi-sekolah-tingkat-smp' => 'smp'])
