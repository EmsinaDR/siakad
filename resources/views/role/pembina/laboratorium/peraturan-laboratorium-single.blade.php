    ...
    <section class='content mx-2 my-4'>
        ...
        <div class='card'>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xl-2">
                        <button type='button' class='btn btn-block btn-default bg-primary btn-md' onclick='TambahData()'> <i class="fa fa-plus"></i>Tambah Peraturan</button>
                    </div>
            ...
            <div class='ml-2 my-4'>
                ...
                <div class="card">
                    <div class='card-header bg-primary'>
                        <h3 class='card-title'>Data Peraturan Laboratorium -
                            {{ $data_laboratoriums->LaboratoriumOne->nama_laboratorium }}</h3>
                    </div>
                    <div class='card-body'>
                        {{-- Catatan :
                                        ...
                                        <td width='0%'>
                                            {{-- blade-formatter-disable --}}
                                                     <div class='gap-1 d-flex justify-content-center'>
                                                            ...
                                                            <form id='delete-form-{{ $data->id }}' action='{{ route('peraturan-laboratorium.destroy', $data->id) }}' method='POST' style='display: inline-block;'>
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
                                    ...
                                    <div class='modal fade' id='editModal{{ $data->id }}' tabindex='-1'
                                        ...
                                        <x-edit-modal>
                                            ...
                                            <section>
                                                {{-- blade-formatter-disable --}}
                                                <form id='updateurl'
                                                    action='{{ route('peraturan-laboratorium.update', $data->id) }}'
                                                    method='POST'>
                                                    @csrf
                                                    @method('PATCH')
                                                    ...
                                                    <div class='form-group'>
                                                        ...
                                                        <input type='text' class='form-control' id='peraturan' name='peraturan' placeholder='Peraturan' alue='{{ $data->peraturan }}' required>
                                                    </div>
                                                    <div class='form-group'>
...
<script>
    $(document).ready(function() {
        initDataTable('#example1',
            'Data Peraturan Laboratorium {{ $data_laboratoriums->LaboratoriumOne->nama_laboratorium }}',
    ...
    <div class='modal-dialog modal-lg'>
        <div class='modal-content'>
            ...
            <div class='modal-body'>
                ...
                <form id='#id' action='{{route('peraturan-laboratorium.store')}}' method='POST'>
                    @csrf
                    @method('POST')
                    {{-- blade-formatter-disable --}}
                    <div class='form-group'>
                        <label for='peraturan'>Peraturan</label>
                        <input type='text' class='form-control' id='peraturan' name='peraturan' placeholder='Peraturan' required>
                    </div>
                    <div class='form-group'>
                        <i class='fas fa-sticky-note'></i><label for='keterangan'>Keterangan</label>
