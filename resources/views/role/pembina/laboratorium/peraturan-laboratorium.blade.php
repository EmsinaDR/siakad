    ...
    <section class='content mx-2 my-4'>
        ...
        <div class='card'>
            ...
            <div class='ml-2 my-4'>
                   peraturan laboratorium
                   <div class="card">
                    <div class='card-header bg-primary'><h3 class='card-title'>Data Peraturan Laboratorium</h3></div>
                    <div class='card-body'>
                        {{--Catatan :
                                ...
                                <table id='example1' width='100%' class='table table-responsive table-bordered table-hover'>
                                    ...
                                    <tbody>
                                           ...
                                           <tr>
                                               ...
                                               <td class='text-center'> {{ $data->peraturan}}</td>
                                               ...
                                               <td width='20%'>
                                                     <div class='gap-1 d-flex justify-content-center'>
                                                            ...
                                                            <form action='{{ route('peraturan-laboratorium.destroy', $data->id) }}' method='POST' style='display: inline-block;'>
                                                                @csrf
                                                                @method('DELETE')
                                             ...
                                             <div class='modal fade' id='editModal{{ $data->id }}' tabindex='-1' aria-labelledby='EditModalLabel' aria-hidden='true'>
                                                 ...
                                                 <x-edit-modal>
                                                     ...
                                                     <section>
                                                            <form id='updateurl' action='{{ route('peraturan-laboratorium.update', $data->id) }}' method='POST'>
                                                                @csrf
                                                                @method('PATCH')
