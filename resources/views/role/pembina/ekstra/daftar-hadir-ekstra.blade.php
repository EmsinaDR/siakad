                        ...
                        @foreach ($datas as $data)
                            <tr>
                                ...
                                <td class='text-center'>
                                    ...
                                    <a
                                        href="{{ app('request')->root() }}/waka-kesiswaan/daftar-hadir-ekstrakurikuler/{{ $data->id }}"><span
                                        ...
                                        <form id='updateurl' action='{{ route('ekstrakurikuler.update', $data->id) }}'
                                            ...
                                            <script>
                                               $(document).ready(function() {
                                                   ...
                                                   $('#select2-{{ $data->id }}').val(@json($data->detailguru_id)).trigger('change'); // Mutiple Select Select value in array json
                                               });
                                            </script>
