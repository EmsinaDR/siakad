                            ...
                            <thead>
                                <tr class='text-center align-middle'>
                                    ...
                                    @foreach ($arr_ths as $arr_th)
                                        <th  class='text-center align-middle'colspan='1' rowspan='2' class='text-center'> {{ $arr_th }}</th>
                                    @endforeach
                                    <th  class='text-center align-middle'colspan='2'>Surat</th>
                                    <th  class='text-center align-middle'colspan='1' rowspan='2'>Action</th>
                                    {{-- @if ($activecrud === 1)
                                              {{-- @endif --}}
                                </tr>
                                    <th class='text-center align-middle'>SKN</th>
                                    ...
                                    <tr>
                                        ...
                                        <td width='10%'>
                                            ...
                                            <div class='gap-1 d-flex justify-content-center'>
                                                ...
                                                <form id='delete-form-{{ $data->id }}' action='{{ route('surat-kelulusan.destroy', $data->id) }}' method='POST' style='display: inline-block;'>
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            ...
                                            <div class='modal fade' id='editModal{{ $data->id }}' tabindex='-1'
                                                ...
                                                <x-edit-modal>
                                                    ...
                                                    <section>
                                                        <form id='updateurl'
                                                            action='{{ route('surat-kelulusan.update', $data->id) }}'
                                                            method='POST'>
                                                            @csrf
                                                            @method('PATCH')
