        ...
        <div class='card'>
            ...
            <tbody>
                   ...
                   <tr>
                       ...
                       <td class='text-center'> {{ $data->fillable}}</td>
                       ...
                       <td width='10%'>
                                            ...
                                            <div class='d-flex justify-content-center'>
                                                ...
                                                <form id='delete-form-{{ $data->id }}' action='{{ route('pulang-cepat.destroy', $data->id) }}' method='POST' style='display: inline-block;'>
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                              ...
                              <div class='modal fade' id='editModal{{ $data->id }}' tabindex='-1' aria-labelledby='EditModalLabel' aria-hidden='true'>
                                  <x-edit-modal>
                                      ...
                                      <section>
                                             <form id='update-pulang-cepat' action='{{ route('pulang-cepat.update', $data->id) }}' method='POST'>
                                                 @csrf
                                                 @method('PATCH')
