                                    ...
                                    <tr>
                                        ...
                                        <td width='10%'>
                                            ...
                                            <div class='d-flex justify-content-center'>
                                                ...
                                                <form id='delete-form-{{ $data->id }}' action='{{ route('sosialisasi-vendor.destroy', $data->id) }}' method='POST' style='display: inline-block;'>
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            ...
                                            <div class='modal fade' id='editModal{{ $data->id }}' tabindex='-1'
                                                ...
                                                <x-edit-modal>
                                                    ...
                                                    <section>
                                                        <form id='update-sosialisasi-vendor'
                                                            action='{{ route('sosialisasi-vendor.update', $data->id) }}'
                                                            method='POST'>
                                                            @csrf
                                                            @method('PATCH')
    ...
    <div class='modal-dialog modal-lg'>
        <div class='modal-content'>
            ...
            <div class='modal-body'>
                ...
                <form id='TambahData-form' action='{{ route('sosialisasi-vendor.store') }}' method='POST'>
                    @csrf
                    @method('POST')
                    <div class='form-group'>
                        <label for='judul'>Judul</label>
                        <input type='text' class='form-control' id='judul' name='judul'
                            placeholder='Isikan judul data' required>
                    </div>
                    <div class='form-group'>
                        <label for='kategori'>Kategori Data</label>
                        <input type='text' class='form-control' id='kategori' name='kategori'
                            placeholder='Kategori Sosialisasi' required>
                    </div>
                    <div class='form-group'>
                        <i class='fas fa-sticky-note pr-2'></i><label for='pesan'>Pesan Whatsapp</label>
                        <textarea name='pesan' id='pesan' rows='3' class='form-control'
                            placeholder='Masukkan Pesan Whatsapp Singkat'></textarea>
                    </div>
                    <div class='form-group'>
