        ...
        <div class='card'>
            ...
            <tbody>
                   ...
                   <tr>
                       ...
                       <td class='text-center'> {{ $data->judul}}</td><td class='text-center'> {{ $data->kategori}}</td><td class='text-center'> {{ $data->aplikasi}}</td><td class='text-center'> {{ $data->pesan}}</td><td class='text-center'> {{ $data->target}}</td><td class='text-center'> {{ $data->jam}}</td><td class='text-center'> {{ $data->tanggal}}</td><td class='text-center'> {{ $data->keterangan}}</td><td class='text-center'> {{ $data->jumlah_terkirim}}</td><td class='text-center'> {{ $data->}}</td>
                       ...
                       <td width='10%'>
                              ...
                              <div class='modal fade' id='editModal{{ $data->id }}' tabindex='-1' aria-labelledby='EditModalLabel' aria-hidden='true'>
                                  <x-edit-modal>
                                      ...
                                      <section>
                                             <form id='update-sosialisasi-vendor' action='{{ route('sosialisasi-vendor.update', $data->id) }}' method='POST'>
                                                 @csrf
                                                 @method('PATCH')
