                    ...
                    <tbody>
                        @foreach ($datas as $data)
                            <tr>
                                ...
                                <td class='text-center'> {{ $data->jamke }}</td>
                                <td class='text-center'> {{Carbon::create($data->deadline)->translatedformat('l, d F Y')}}</td>
...
<script>
    $(document).ready(function() {
        initDataTable('#example1', 'Data Tugas Hari - {{$Tanggal}}', '#example1_wrapper .col-md-6:eq(0)');
