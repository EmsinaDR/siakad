                                    ...
                                    <tr>
                                        ...
                                        <td width='10%'>
                                            <div class='gap-1 d-flex justify-content-center'>
                                                ...
                                                <a href="{{route('data-nilai-pts-pas.index')}}/{{$data->mapel_id}}"><button type='button' class='btn btn-warning btn-sm btn-equal-width' data-toggle='modal' data-target='#editModal{{ $data->id }}'><i class='fa fa-eye'></i> </button></a>
