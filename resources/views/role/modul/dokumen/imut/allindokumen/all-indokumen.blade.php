...
<x-layout>
    ...
    <section class='content mx-2 my-4'>
        ...
        <div class='card'>
            ...
            <tbody>
                   @foreach ($AllIndokumen as $data)
                   <tr>
                       <td class='text-center'>{{ $loop->iteration }}</td>
                       <td class='text-center'> {{ $data->nama_dokumen}}</td><td class='text-center'> {{ $data->slug}}</td><td class='text-center'> {{ $data->keterangan}}</td>
