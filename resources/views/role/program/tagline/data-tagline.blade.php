                                           ...
                                           <tr>
                                               ...
                                               <td width='10%'>
                                                   <div class='gap-1 d-flex justify-content-center'>
                                                       ...
                                                       <a href="{{route('tagline.edit', $data->id)}}"><button type='button' class='btn btn-warning btn-sm btn-equal-width' ><i class='fa fa-edit'></i> </button></a>
                                                       <!-- Form untuk menghapus -->
                                                       <form id='delete-form-{{ $data->id }}'
                                                           action='{{ route('tagline.destroy', $data->id) }}' method='POST'
                                                      ...
                                                      <div class='modal fade' id='editModal{{ $data->id }}' tabindex='-1' aria-labelledby='EditModalLabel' aria-hidden='true'>
                                                          ...
                                                          <x-edit-modal>
                                                              ...
                                                              <section>
                                                                     <form id='updateurl' action='{{ route('tagline.update', $data->id) }}' method='POST'>
                                                                         @csrf
                                                                         @method('PATCH')
