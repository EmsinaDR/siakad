                            ...
                            <tbody>
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td class='text-center'> {{ $data->Tapel->tapel }} -
                                            {{ $data->Tapel->tapel + 1 }}</td>
                                        <td class='text-center'> {{ $data->kategori }}</td>
                                        <td class='text-center'> {{ $data->Guru->nama_guru }}</td>
                                        <td class='text-center'> {{Carbon::create($data->tanggal_pelaksanaan)->translatedformat('l, d F Y')}}</td>
                                        ...
                                        <td width='10%'>
                                            <div class='gap-1 d-flex justify-content-center'>
                                                ...
                                                <form id='delete-form-{{ $data->id }}'
                                                    action='{{ route('jadwal-supervisi-waka.destroy', $data->id) }}'
                                            ...
                                            <div class='modal fade' id='editModal{{ $data->id }}' tabindex='-1'
                                                ...
                                                <x-edit-modal>
                                                    ...
                                                    <section>
                                                        <<form id="updateurl"
                                                            action="{{ route('jadwal-supervisi-waka.update', $data->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="kategori" name="kategori" placeholder="Jabatan"
