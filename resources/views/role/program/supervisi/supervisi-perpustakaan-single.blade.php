                    ...
                    <div class='card-body'>
                            ...
                            <div class="col-xl-6">
                                <table id='example1' width='100%' class='table table-bordered'>
                                    <tr class='text-center align-middle'>
                                        ...
                                        <td class='text-left'> : {{ $Identitas->jenjang }}{{ $Identitas->nomor }} {{ $Identitas->namasek }}</td>
                                    </tr>
                                    <tr class='text-center align-middle'>
                                        <td width='35%' class='text-left'>Nama Guru</td>
                                        <td class='text-left'> : {{$PetugasId->nama_guru}}</td>
                                    </tr>
                                    <tr class='text-center align-middle'>
                                        <td width='35%' class='text-left'>NIP/NUPTK</td>
                                        <td class='text-left'> : {{$PetugasId->nip}}td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-xl-6 mt-1">
                                <table id='example1' width='100%' class='table table-bordered'>
                                    <tr class='text-center align-middle'>
                                        ...
                                        <td class='text-left'> : Tahun {{$PetugasId->tahun_sertifikasi}} </td>
                                    </tr>
                                    <tr class='text-center align-middle'>
                        ...
                        <script>
                            ...
                            function saveChange(event, inputField, id, field) {
                                ...
                                $.ajax({
                                    url: `/program/supervisi/supervisi-perpustakaan/${id}`,
                                    method: 'PUT',
                                    data: {
