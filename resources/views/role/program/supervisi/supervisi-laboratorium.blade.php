                                        ...
                                        <td width='10%'>
                                            {{-- blade-formatter-disable --}}
                                                   <div class='gap-1 d-flex justify-content-center'>
                                                       ...
                                                       <form action="{{ route('supervisi-laboratorium.store') }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('POST')
                                                            <input type="hidden" name="kategori" value="Laboratorium">
                                                       ...
                                                       <form id='delete-form-{{ $data->id }}' action='{{ route('supervisi-laboratorium.destroy', $data->id) }}' method='POST' style='display: inline-block;'>
                                                           @csrf
                                                           @method('DELETE')
                                                       </form>
                                            ...
                                            <div class='modal fade' id='editModal{{ $data->id }}' tabindex='-1'
                                                ...
                                                <x-edit-modal>
                                                    ...
                                                    <section>
                                                        <form id='updateurl'
                                                            action='{{ route('supervisi-laboratorium.update', $data->id) }}'
                                                            method='POST'>
                                                            @csrf
                                                            @method('PATCH')
