    ...
    <section class='content mx-2 my-4'>
        ...
        <div class='card'>
            ...
            {{-- blade-formatter-disable --}}
               <div class='row m-2'>
                   <div class='col-xl-2'>
                       <form action="{{ route('supervisi-waka-kesiswaan.store') }}"
                            method="POST">
                            @csrf
                            @method('POST')
                            <input type="hidden" name="bidang" value="Waka Kesiswaan">
                                        ...
                                        <td width='10%'>
                                            <div class='gap-1 d-flex justify-content-center'>
                                                ...
                                                <form id='delete-form-{{ $data->tapel_id }}'
                                                    action='{{ route('supervisi-waka-kesiswaan.destroy', $data->tapel_id) }}'
                                            ...
                                            <div class='modal fade' id='editModal{{ $data->id }}' tabindex='-1'
                                                ...
                                                <x-edit-modal>
                                                    ...
                                                    <section>
                                                        <form id='updateurl'
                                                            action='{{ route('supervisi-waka-kesiswaan.update', $data->tapel_id) }}'
                                                            method='POST'>
                                                            @csrf
                                                            @method('PATCH')
