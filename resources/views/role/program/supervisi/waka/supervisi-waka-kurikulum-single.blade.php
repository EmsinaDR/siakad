                ...
                <div class='card'>
                    ...
                    <div class='card-body'>
                            ...
                            <div class="col-xl-6">
                                <table id='example1' width='100%' class='table table-bordered'>
                                    ...
                                    <tr class='text-center align-middle'>
                                        ...
                                        <td class='text-left'> : {{$detailGuru->nama_guru}}</td>
                                    </tr>
                                    <tr class='text-center align-middle'>
                                        <td width='35%' class='text-left'>NIP/NUPTK</td>
                                        <td class='text-left'> : {{$detailGuru->nip}}</td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-xl-6 mt-1">
                                <table id='example1' width='100%' class='table table-bordered'>
                                    <tr class='text-center align-middle'>
                                        ...
                                        <td class='text-left'> : Tahun {{$detailGuru->tahun_sertifikasi}} </td>
                                    </tr>
                                    <tr class='text-center align-middle'>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <tbody>
                                @foreach ($Instrumens as $kategori => $items)
                                    <tr class="table-info">
                                        <th colspan="5" class="text-left">
                                            {{ $kategori ?: 'Tanpa Sub Kategori' }}
                                            <!-- Memeriksa apakah kategori muncul -->
                                        </th>
                                    </tr>
