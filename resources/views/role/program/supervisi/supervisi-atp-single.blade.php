        ...
        <div class='card'>
            ...
            <div class='ml-2 my-4'>
                <div class='card'>
                    ...
                    <div class='card-body'>
                        <h3 class="text-center"><b>INSTRUMEN PENILAIAN ALUR TUJUAN PEMBELAJARAN</b></h3>
                        ...
                        <table id="example1x" width="100%" class="table table-bordered table-hover">
                            <thead>
                                <tr class='table-success'>
                                    ...
                                    <th class="text-center align-middle" rowspan="3">Indikator</th>
                                    <th class="text-center align-middle" rowspan='1' colspan="3">Penilaian</th>

                                    <th class="text-center align-middle" rowspan="3">Keterangan</th>
                                </tr>
                                <tr class='table-success'>
                                    <th width='10%' class="text-center align-middle" colspan='2'>Ya</th>
                                    <th width='10%' class="text-center align-middle"rowspan='2'>Tidak</th>
                                </tr>
                                <tr class='table-success'>
                                    <th width='10%' class="text-center align-middle">Sesuai</th>
                                    <th width='10%' class="text-center align-middle">Tidak Sesuai</th>
                                </tr>
                            </thead>
                            <tbody>
                            ...
                            $(document).ready(function() {
                                    ...
                                    $('tbody tr').each(function() {
                                        ...
                                        $(this).find('.editable').each(function() {
                                            ...
                                            if ($.isNumeric(currentValue) && currentValue !== "") {
                                                rowTotal += parseFloat(
                                                    currentValue); // Menjumlahkan nilai dalam satu baris
                                ...
                                $(document).on('click', '.editable', function() {
                                    ...
                                    inputField.on('keydown', function(e) {
                                        ...
                                        if (e.key === 'Enter') {
                                            ...
                                            if (newValue !== currentValue) {
                                                $.ajax({
                                                    url: "/program/supervisi/supervisi-perangkat-guru/" +
                                                        indikatorId,
                                                    type: "PUT",
                                                    headers: {
                                                    ...
                                                    success: function(response) {
                                                        ...
                                                        // alert(response.message);
                                                        cell.text(
                                                            newValue); // Update tampilan dengan nilai baru
                                                        updateTotal(); // Update total setelah perubahan
                                                    },
                                                    error: function(xhr) {
                                                        ...
                                                        alert("Terjadi kesalahan saat memperbarui data.");
                                                        cell.text(
                                                            currentValue); // Kembalikan nilai jika gagal
                                                    }
                                                });
                                            } else {
                                                cell.text(
                                                    currentValue); // Jika tidak ada perubahan, kembalikan nilai lama
                                            }
                                        }
                                ...
                                $(document).on('click', '.editable-keterangan', function() {
                                    ...
                                    inputField.blur(function() {
                                        ...
                                        $.ajax({
                                            url: "/program/supervisi/supervisi-perangkat-guru/" +
                                                indikatorId, // URL yang sama untuk update data
                                    ...
                                    inputField.on('keydown', function(e) {
                                        ...
                                        if (e.key === 'Enter') {
                                            ...
                                            if (newValue !== currentValue) {
                                                ...
                                                cell.text(
                                                    currentValue); // Kembalikan ke nilai awal jika tidak ada perubahan
                                            }
                                        }
