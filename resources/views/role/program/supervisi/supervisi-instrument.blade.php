                                ...
                                <table id='example1' width='100%' class='table table-responsive table-bordered table-hover'>
                                    ...
                                    <tbody>
                                           ...
                                           <tr>
                                               ...
                                               <td width='10%' class='text-center'> {!! $data->bidang!!}</td>
                                               <td class='text-left'> {!! $data->kategori!!}</td>
                                               <td width='40%' class='text-left'> {!! $data->indikator!!}</td>
                                               ...
                                               <td width='10%'>
                                                   <div class='gap-1 d-flex justify-content-center'>
                                                       ...
                                                       <form id='delete-form-{{ $data->id }}'
                                                           action='{{ route('instrument-supervisi.destroy', $data->id) }}' method='POST'
                                                      ...
                                                      <div class='modal fade' id='editModal{{ $data->id }}' tabindex='-1' aria-labelledby='EditModalLabel' aria-hidden='true'>
                                                          ...
                                                          <x-edit-modal>
                                                              ...
                                                              <section>
                                                                     <form id='updateurl' action='{{ route('instrument-supervisi.update', $data->id) }}' method='POST'>
                                                                         @csrf
                                                                         @method('PATCH')
