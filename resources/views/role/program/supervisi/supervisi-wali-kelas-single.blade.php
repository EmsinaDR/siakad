        ...
        <div class='card'>
            ...
            <div class='ml-2 my-4'>
                <div class='card'>
                    ...
                    <div class='card-body'>
                        <h3 class="text-center"><b>INSTRUMEN PENILAIAN WALI KELAS</b></h3>
                            ...
                            <div class="col-xl-6">
                                <table id='example1' width='100%' class='table table-bordered'>
                                    ...
                                    <tr class='text-center align-middle'>
                                        ...
                                        <td class='text-left'> : {{ $DataKelas->kelastoDetailguru->nama_guru }}</td>
                                    </tr>
                                    <tr class='text-center align-middle'>
                                        <td width='35%' class='text-left'>NIP/NUPTK</td>
                                        <td class='text-left'> : {{ $DataKelas->kelastoDetailguru->nip }}</td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-xl-6 mt-1">
                                <table id='example1' width='100%' class='table table-bordered'>
                                    <tr class='text-center align-middle'>
                                        ...
                                        <td class='text-left'> : Tahun ..................
                                            {{ $DataKelas->kelastoDetailguru->tahun_sertifikasi }}</td>
                                    </tr>
                                    <tr class='text-center align-middle'>
                        ...
                        <script>
                            ...
                            function saveChange(event, inputField, id, field) {
                                ...
                                $.ajax({
                                    url: `/program/supervisi/supervisi-wali-kelas/${id}`,
                                    method: 'PUT',
                                    data: {
                        ...
                        {{-- <div class='card my-4'>
                            ...
                            <div class='card-body'>
                                <form id='save-saran-form' action='{{ route('save.saran.supervisi') }}' method='POST'>
                                    @csrf
                                    @method('POST')
