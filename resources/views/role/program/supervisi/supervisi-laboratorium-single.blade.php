        ...
        <div class='card'>
            ...
            <div class='ml-2 my-4'>
                <div class='card'>
                    ...
                    <div class='card-body'>
                        <h3 class="text-center"><b>INSTRUMEN PENILAIAN LABORATORIUM</b></h3>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($Instrumens as $sub_kategori => $items)
                                    <tr class="table-info">
                                        <th colspan="5" class="text-left">{{ $sub_kategori ?: 'Tanpa Sub Kategori' }}
                                        </th>
                                    </tr>
                        ...
                        <script>
                            ...
                            function saveChange(event, inputField, id, field) {
                                ...
                                $.ajax({
                                    url: `/program/supervisi/supervisi-laboratorium/${id}`,
                                    method: 'PUT',
                                    data: {
