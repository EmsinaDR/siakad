                                        ...
                                        <td width='10%'>
                                            <div class='gap-1 d-flex justify-content-center'>
                                                ...
                                                <form id='delete-form-{{ $data->id }}'
                                                    action='{{ route('klasifikasi-surat.destroy', $data->id) }}'
                                            ...
                                            <div class='modal fade' id='editModal{{ $data->id }}' tabindex='-1'
                                                ...
                                                <x-edit-modal>
                                                    ...
                                                    <section>
                                                        {{-- blade-formatter-disable --}}
                                                        <form id='updateurl' action='{{ route('klasifikasi-surat.update', $data->id) }}' method='POST'>
                                                            @csrf
                                                            @method('PATCH')
                                                            <div class='form-group'>
                                                                <label for='kode'>Kode</label>
                                                                <input type='text' class='form-control' id='kode' name='kode' placeholder='Kode' value='{{$data->kode}}' disabled>
                                                            </div>
                                                            <div class='form-group'>
                                                                <label for='nama'>Nama Klasifikasi</label>
                                                                <input type='text' class='form-control' id='nama' name='nama' placeholder='Nama Klasifikasi' value='{{$data->nama}}' required>
                                                            </div>
                                                            <div class='form-group'>
                                                                <i class='fas fa-sticky-note'></i><label for='keterangan'>Judul</label>
        ...
        <div class='modal-content'>
            ...
            <div class='modal-body'>
                ...
                <form id='#id' action='' method='POST'>
                    ...
                    <div class='form-group'>
                        <label for='nama'>Nama Klasifikasi</label>
                        <input type='text' class='form-control' id='nama' name='nama' placeholder='Nama Klasifikasi' value="{{ old('nama') }}" required>
                    </div>
                    <div class='form-group'>
                        <i class='fas fa-sticky-note'></i><label for='keterangan'>Keterangan</label>
                        <textarea name='keterangan' id='keterangan' rows='3' class='editor form-control' placeholder='Masukkan Keterangan untuk memperudah dan sebagai acuan penggunaan'>{{ old('keterangan') }}</textarea>
                    </div>
