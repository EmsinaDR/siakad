        ...
        <div class='card'>
            ...
            <!--Car Header-->
                ...
                <div class="col-3 my-4">
                    <form id='post_mapel'
                        action='{{ route('Walkes-DataNilai.tugas', ['kelas_id' => request('kelas_id')]) }}'
                        method='POST'>
                        @csrf
                        ...
                        <div class="col">
                            <button id='submiter' type='submit' class='btn btn-default bg-primary btn-lg float-right' style="display: none;">Kirim</button>
                        </div>
                    </form>
                </div>
            <div class='ml-2'>
                    ...
                    <tbody>
                        @foreach ($datas as $data)
                            <tr>
                                ...
                                <td width='8%' class='text-center'> {{ $data->EnilaitugastoDetailSiswas->nis }}
                                </td>
