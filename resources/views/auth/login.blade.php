...
@php
    $logoIco = $Identitas === 'Sekolah Cipta IT' ? 'img/dev/logo.ico' : 'img/logo.ico';
    $logo = $Identitas === 'Sekolah Cipta IT' ? 'img/dev/logo.png' : 'img/logo.png';
@endphp
    ...
    <div class="container mb-4"><br>
        ...
        <div class="col-md-5 mx-auto">
            ...
            <div class="text-center">
                <img class='img-circle img-fluid mx-auto mb-2' style='width:100px;height:100px;margin-top:100px' src="{{ asset($logo)}}" alt="">
            </div>
            ...
            <form action="{{ route('login') }}" method="post">
                ...
                <div class="row my-2">
                    <div class="col-12 d-flex flex-row justify-content-end gap-4 p-1">
                        <button type="submit" class="btn btn-primary w-auto m-1">Log In</button>
                        <button type="button" class="btn btn-success w-auto m-1" onclick="absenNow()">Absen Siswa</button>
                        <button type="button" class="btn btn-success w-auto m-1" onclick="absenGuru()">Absen Guru</button>
                    </div>
                </div>
                <hr>
