...
for($i=0;$i< count($pairs);$i++): $pairs[$i]=explode(':', $pairs[$i]); endfor; @endphp @for($i=0; $i < count($pairs); $i++) {{-- <div class='form-group p-2'> --}} <label class='mt-2' for='{{ $pairs[$i][4] }}'>{{ $pairs[$i][1] }}</label>
    ...
    <input type='number' class='form-control text-center' id='{{ $pairs[$i][4] }}' name='{{ $pairs[$i][3] }}' placeholder='{{ $pairs[$i][2] }}' value='{{ $pairs[$i][5]}}' {{ $pairs[$i][6]}} max="100">
    ...
    <input type='readonly' class='form-control bg-white' id='{{ $pairs[$i][4] }}' name='{{ $pairs[$i][3] }}' placeholder='{{ $pairs[$i][2] }}' value='{{ $pairs[$i][5]}}' {{ $pairs[$i][6]}}>
    ...
    <select id='{{$pairs[$i][4]}}' class='select2 form-control' name='{{$pairs[$i][3]}}' data-placeholder='{{$pairs[$i][2]}}' style='width: 100%;' {{$pairs[$i][6]}}>
