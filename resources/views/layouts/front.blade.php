...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ app('request')->root() }}/img/logo.ico">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary"><i class="fa fa-book me-3"></i>{{ $Identitas->namasek }}</h2>
        </a>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        ...
                        <a href="testimonial.html" class="dropdown-item">Sarana dan Prasarana</a>
                        <a href="testimonial.html" class="dropdown-item">Kemitraan</a>
                        <a href="testimonial.html" class="dropdown-item">Prestasi</a>
                        <a href="404.html" class="dropdown-item">Sistem Nilai</a>
                    </div>
                </div>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Sarana dan
                        Prasarana</a>
                    <div class="dropdown-menu fade-down m-0">
                        <a href="team.html" class="dropdown-item">Gedung</a>
                        <a href="testimonial.html" class="dropdown-item">Sistem</a>
                        <a href="testimonial.html" class="dropdown-item">Sarana dan Prasarana</a>
                        <a href="testimonial.html" class="dropdown-item">Kemitraan</a>
                        <a href="testimonial.html" class="dropdown-item">Prestasi</a>
                        <a href="404.html" class="dropdown-item">Sistem Nilai</a>
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Portal Siswa</a>
                    <div class="dropdown-menu fade-down m-0">
                        <a href="team.html" class="dropdown-item">PPDB</a>
                        <a href="testimonial.html" class="dropdown-item">Sistem Absensi</a>
                        <a href="404.html" class="dropdown-item">Sistem Nilai</a>
                    </div>
                </div>
                <a href="contact.html" class="nav-item nav-link">Contact</a>
            </div>
            <a href="" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Login Now<i
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">{{ $Identitas->namasek }}</a>, All Right
                        Reserved.
